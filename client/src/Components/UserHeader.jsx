        ...
        <header className='fixed bottom-0 w-full' style={{ backgroundColor: '#fceed1' }}>
            ...
            <div className='flex justify-between mx-auto p-3 items-center'>
                <Link to='/order' className='hover:underline'>
                    <i className='fas fa-map-marker-alt ml-4' style={{ color: 'gray' }}></i>
                </Link>
